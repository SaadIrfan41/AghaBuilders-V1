...
const services = [
    ...
    },
    {
        ...
        description: 'Revamp your space  with our experts, We blend functionality and aesthetics for stunning results.',
    },
    {
        count: 3,
        title: 'Maintenance',
        icon: require('./../../images/icon/toolbox.png'),
        description: 'From groundwork to finishing, we build robust structures tailored to your needs and standards.',
    },
    {
        count: 4,
        title: 'Design',
        icon: require('./../../images/icon/compass.png'),
        description: 'Elevate your space with premium materials and flawless craftsmanship for walls, floors, and ceilings.',
    }
]
